...
/***/ "./resources/js/components/suggestInput.js":
/*!*************************************************!*\
  !*** ./resources/js/components/suggestInput.js ***!
  \*************************************************/
/***/ (() => {
  ...
  return {
    ...
    init: function init() {
      ...
      if (!!this.dispatch_event_name) {
        this.dispatchEvent();
        this.$watch('current_value', function (value) {
          _this.dispatchEvent();
        });
      }
    },
    dispatchEvent: function dispatchEvent() {
      ...
      this.$nextTick(function () {
        _this2.$el.dispatchEvent(new CustomEvent(_this2.dispatch_event_name, {
          bubbles: true,
          detail: {
            current_value: _this2.current_value,
            current_label: _this2.current_label
          }
        }));
      });
    },
    ...
    filterOptions: function filterOptions(input, doShowOptions) {
      ...
      if (this.options_url) {
        ...
        axios.post(this.options_url, {
          ...
          _this3.parseOptions(options);
        })["catch"](function (error) {
          alert(getReadableAxiosError(error));
        })["finally"](function () {
          _this3.options_loading = false;

          _this3.afterFilterOptions(doShowOptions);
        });
      } else {
    ...
    onClearInputTabAway: function onClearInputTabAway() {
      ...
      if (this.as_select) {
        this.$nextTick(function () {
          _this7.$refs.select_button.focus();
        });
      }
    }
  };
